...
pytestmark = pytest.mark.skipif(
    ...
    reason="requires locally built current release images and cached legacy image",
)
...
def test_packaged_services_restore_research_auth_and_native_authority(tmp_path):
