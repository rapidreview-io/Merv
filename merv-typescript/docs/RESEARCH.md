...
| `reflection`      | The approved reflection: `id`, `reviewId`, `approvedAt`, and the report and change specification as `{id, title, hash}`; null when nothing was approved                                                              |
