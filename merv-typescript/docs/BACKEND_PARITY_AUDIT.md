...
| Research evidence and metrics    | Role/attempt-specific plans, results, reports, logic graphs and deterministic metrics exhibits                    | **Missing as a research capability.** Generic immutable artifacts are available                                                                                                                                                                                                | Experiments + Artifacts                                |
...
| Project graph and staleness      | Reviewed changes to project claims/graph, coverage snapshots, stale-knowledge gates and reflection advice         | **Missing.** No authoritative project graph or coverage/staleness calculation                                                                                                                                                                                                  | Research knowledge + Reflection                        |
...
[research tool contracts][py-research-tools], [experiment graph][py-experiment],
[reflection graph][py-reflection], [project synthesis][py-synthesis],
